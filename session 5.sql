...
WHERE language= 'English' OR language='Spanish' 
	AND (release_year = 1990 OR release_year = 1999);
...
SELECT TOP (1) release_year,language
	COUNT(DISTINCT language) AS most_language
FROM films;
WHERE release_year IS NOT NULL
GROUP BY release_year 
ORDER BY most_lanuage;
